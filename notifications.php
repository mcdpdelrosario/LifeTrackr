            ...
            if (mysqli_connect_errno()){
                    ...
                    ?>
                          ...
                          <?php
                                    ...
                                    $query_fr="SELECT friends_id ,n.time_stamp, first_name, last_name, username FROM notifications AS n
                                    INNER JOIN friends AS f
                                      ON n.link_id = f.friends_id
                                      INNER JOIN userinfo AS ui
                                      ON n.user_id = ui.user_id
                                  WHERE n.user_owner=".$_SESSION['userid']." AND n.link_id=".$row['link_id']." ORDER BY time_stamp DESC";
