	...
	<nav class="navbar navbar-default navbar-fixed-top" role = "navigation" id = "navbars">
		<div class="container bar-align">
				<div class="navbar-header active" id ="logo">
					 <a href="login.php" id="signup-but"> <button type="button" class="navbar-toggle">Home</button></a>
						<div class = "logo">
						</div>
				</div>
				<div class="collapse navbar-collapse" id="myNavbar">
					  	...
					  	<ul class="nav navbar-nav navbar-right ">
							<li>
        						 ...
        						 <a href="login.php" id="signup-but"><span class="glyphicon glyphicon-user"></span> Home</a>
